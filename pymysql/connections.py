...
class Connection(object):
    """
    Representation of a socket with a pymysql server.
    ...
    def write_packet(self, payload):
        """Writes an entire "pymysql packet" in its entirety to the network
    ...
    def _read_packet(self, packet_type=MysqlPacket):
        """Read an entire "pymysql packet" in its entirety from the network
